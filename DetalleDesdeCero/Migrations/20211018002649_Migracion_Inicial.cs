    ...
    public partial class Migracion_Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Permiso para administrar el negocio", "Administrar", 0 });

            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "PermisoId", "Descripcion", "Nombre", "vecesAsignado" },
                values: new object[] { 2, "Permiso para cobrar en caja a los clientes", "Cobrar en caja", 0 });

            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "PermisoId", "Descripcion", "Nombre", "vecesAsignado" },
                values: new object[] { 3, "Permiso para vender y atender a los clientes", "Vender", 0 });
